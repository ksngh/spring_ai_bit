...
class UpbitPrompt {
    ...
    fun createInvestPrompt(): String {
        ...
        contentBuilder.append(
            ...
            2. 내가 제공하는 5분 봉 데이터는 총 288개이며, 이는 약 하루치에 해당해.
            3. 너의 목적은: 마지막 캔들 기준으로 30분 후(6개 캔들 이후) 가격이 오를지 떨어질지를 예측하는 것이야.
            ...
            이제 내가 제공하는 288개의 5분봉을 기반으로,
            30분 뒤 가격이 오를 것으로 예측되면 "BUY", 떨어질 것으로 보이면 "SELL" 중 하나만 대답해줘.
            """.trimIndent()
        )
